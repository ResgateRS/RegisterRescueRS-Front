...
export function FamilyItem({ family }: Props) {
  const phoneNumber = parsePhoneNumber(family.cellphone, 'BR')?.formatNational()
  ...
  return (
    <div className="flex w-full items-center justify-between rounded-lg bg-zinc-50 p-10 shadow-lg">
